...
namespace PrimalEditor.Editors
{
    ...
    {
        private Brush _specular = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#ff010101"));
    ...
    class MeshRenderer : ViewModelBase
    {
        ...
        public MeshRenderer(MeshLOD lod, MeshRenderer old)
        {
            ...
            //We packed the vertices to bit value in C++ side, to unpack it we've calculated intervals
            ...
            foreach (var mesh in lod.Meshes)
            {
                ...
                using (var reader = new BinaryReader(new MemoryStream(mesh.Vertices)))
                    for (int i = 0; i < mesh.VertexCount; ++i)
                    {
                        ...
                        //  nx^2 + ny^2 + nz^2 = 1      since normal is normalised
                        //  nz^2 = 1 - nx^2 - ny^2
                        //  nz = ±sqrt(1 - nx^2 - ny^2)
                        // And we packed data about sign of normal in 2nd bit, so taking and with 2 & multiplying
                        ...
                        //Read UVs (skip tagent and joint data)
