...
namespace PrimalEditor.Editors
{
    ...
    public partial class TransformView : UserControl
    {
        ...
        {
            Loaded -= OnTransformViewLoaded;
            (DataContext as MSTranform).PropertyChanged += (s, e) => _propertyChanged = true;
        }
        ...
        {
            if (!(DataContext is MSTranform vm))
            {
                _undoAction = null;
            ...
            (GameEntityView.Instance.DataContext as MSEntity)?.GetMSComponent<MSTranform>().Refresh();
        });
        }
