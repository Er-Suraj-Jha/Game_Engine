...
namespace primal::tools {
	namespace {
		...
		//  Flip_binding for the normal, false means right hand coordinate system other wise left hand coordinate system
		//  UV Range: UV maps are flattened representations of 3d geometry, with coordinate points usually corresponding to
		//  the verticies of a 3d dimensional object.
		mesh create_plane(const primitive_init_info& info, u32 horizontal_index = axis::x, u32 vertical_index = axis::z,
			bool flip_winding = false, v3 offset = { -0.5f,0.f,-0.5f }, v2 u_range = { 0.f,1.f },
			v2 v_range = { 0.f, 1.f })
		{
