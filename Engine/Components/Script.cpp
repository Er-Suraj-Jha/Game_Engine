...
namespace primal::script {
	namespace {
		...
		{
			//NOTE: We put thi static variable in afunction because of
			//      the initialization order of the static data.This way, we can
			//      be certain that the data is initialised before accessing it
